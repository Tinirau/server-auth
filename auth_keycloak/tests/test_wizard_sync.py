...
class TestWizard(TestKeycloakWizBase):
    ...
    def test_get_token(self):
        ...
        self.assertListEqual(
            sorted(parse.parse_qsl(request.body)), sorted(expected)
        )
    ...
    def test_sync_by_username(self):
        ...
        self.assertEqual(
            self.user_donald.oauth_uid, u"1feb89e6-76bd-44a1-ab5d-df28b6477e19"
        )
        self.assertEqual(self.user_donald.oauth_provider_id, self.provider)
        self.assertEqual(
            self.user_john.oauth_uid, u"ef1d2e5d-1aad-4daf-858e-f246168a10ef"
        )
